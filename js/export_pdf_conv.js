...
async function exportarParaPDF() {
    try {
        const convivenciasRef = collection(db, "convivencias");
        ...
        // Cabeçalho
        doc.setFontSize(18);
        doc.text("Relatório de Convivências", 15, 15);
        doc.setFontSize(10);
        ...
        doc.autoTable({
            head: [['Data Criação', 'Data', 'Faltantes', 'Local']],
            body: body,
            startY: 25,
            theme: 'grid',
            styles: { fontSize: 10 },
        ...
        // Salvar PDF
        doc.save(`convivencias_${new Date().toISOString().split('T')[0]}.pdf`);
